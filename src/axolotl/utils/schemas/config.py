...
class AxolotlInputConfig(
    ...
    memory_profiler_steps: int | None = Field(
        default=None,
        json_schema_extra={
            "description": "Enable the memory profiler to capture the first N steps of training to the output_dir. see https://pytorch.org/blog/understanding-gpu-memory-1/ for more information. Snapshots can be visualized @ https://pytorch.org/memory_viz"
        },
    )
    memory_profiler_steps_start: int | None = Field(
        default=0,
        json_schema_extra={
